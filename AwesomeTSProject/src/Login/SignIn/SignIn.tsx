...
import {baseUrl, getUse, getUseInfo} from "../../url_API/Api";
import {loginUse} from "../../redux/acction/actions";
import store from "../../redux/store";
import {checkAccount, checkPassword} from "../../url_API/checkUse/checksUse";
...
function SignIn() {
    ...
    const  onSubmit = async (dataFrom: any) => {
        console.log(dataFrom.account)
        let check1 = checkPassword(dataFrom.password)
        let check2 = checkAccount(dataFrom.account)
         if ( await check1 && await  check2) {
            disPatch(loginUse(getUseInfo(dataFrom.account)));
